...
void ARTSCameraPlayerController::OnInputStarted()
{
	StopMovement();
}

// Triggered every frame when the input is held down
void ARTSCameraPlayerController::OnSetDestinationTriggered()
{
...
// Triggered every frame when the input is held down
void ARTSCameraPlayerController::OnTouchTriggered()
{
	bIsTouch = true;
	OnSetDestinationTriggered();
}

void ARTSCameraPlayerController::OnTouchReleased()
{
	bIsTouch = false;
